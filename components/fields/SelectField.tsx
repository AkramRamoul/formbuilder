...
function FormComponent({
  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      ...
      {helperText && (
        <p className={cn("text-muted-foreground", error && "text-red-500")}>
          {helperText}
        </p>
      )}
    </div>
...
function PropertiesComponent({
  ...
  function applyChanges(values: propertiesFormSchemaType) {
    ...
    toast({
      title: "succes",
      description: "properties saves succesfully",
    });
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                The label of the field . <br /> it will be displayed above field
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>The place holder</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
